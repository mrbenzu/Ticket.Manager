...
public class SeatMap : Entity
{
    ...
    private SeatMap(int noNumericPlaceCount, int sectorCount, int rowsCount, int seatsInRowCount)
    {
    ...
    {
        return new SeatMap(noNumericPlaceCount, sectorCount, rowsCount, seatsInRowCount);
    }
}